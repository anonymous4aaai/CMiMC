...
from coperception_origin.utils.mean_ap import eval_map
from coperception_origin.models.det import *
from coperception_origin.utils.detection_util import late_fusion
...
if __name__ == "__main__":
    ...
    # # # debug params
    # args.data =coperception_old/data/V2X-Sim-1-det/test'
    # args.com = 'lowerbound'
    # args.nepoch = 110
    # args.rsu = 1
    # args.MMI_flag = 0
    ...
    # args.logpath = 'coperception_origin/tools/det/logs_v1/'
    # args.resume = os.path.join(args.logpath,args.com,"with_rsu","epoch_{}.pth".format(args.nepoch))
    # args.logpath = 'coperception_origin/tools/det/logs_v1_DIM_seed{}/logs_lr{}_{}_L{}+G{}'.format(args.seed,args.lr_MMI,args.weight_miloss,args.weight_LMI,args.weight_GMI)
    # args.resume = os.path.join(args.logpath,"disco+no_kd+MMI+"+str(args.alpha),"with_rsu","epoch_{}.pth".format(args.nepoch))
    # # =============
